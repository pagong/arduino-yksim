...
void setup() {
  ...
  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "turnvereinigungbuntebieberburgen", 16);
  ...
  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "kuechenherde", 6);
  yubikey_eeset_private(buffer);

  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "vveinhundert", 6);
  yubikey_eeset_public(buffer, 6);

  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "vielefettehennenlegenrundereeier", 16);
