...
void setup() {
  ...
  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "rundekuheuterliefernbutterkugeln", 16);
  ...
  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "lichterkette", 6);
  yubikey_eeset_private(buffer);

  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "vvuneduedrei", 6);
  yubikey_eeset_public(buffer, 6);

  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, "diegluecklichehennelegtdickeeier", 16);
